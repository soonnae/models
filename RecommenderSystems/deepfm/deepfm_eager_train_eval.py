...
def train(args):
    ...
    evaluate_model(args, deepfm_module, tag="test", cur_step=step, epoch=epoch)
...
def evaluate_model(args, deepfm_module, tag="val", cur_step=0, epoch=0, cached_eval_batches=None):
    if tag == "val":
