...
def preprocess_for_training(train_A_dir, train_B_dir, cache_folder):
    ...
    (
        ...
        coded_sps_A_mean,
        coded_sps_A_std,
    ) = preprocess.coded_sps_normalization_fit_transform(
    ...
    np.savez(
        os.path.join(cache_folder, "logf0s_normalization.npz"),
    ...
    np.savez(
        os.path.join(cache_folder, "mcep_normalization.npz"),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train_B_dir",
        type=str,
        help="Directory for target voice sample",
        default=train_B_dir_default,
    )
    parser.add_argument(
        "--cache_folder",
        type=str,
        help="Store preprocessed data in cache folders",
        default=cache_folder_default,
    )
